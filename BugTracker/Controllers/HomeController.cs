...
public class HomeController : Controller
{
    ...
    public HomeController(ILogger<HomeController> logger, IBTCompanyInfoService companyInfoService,
        SignInManager<BTUser> signInManager, IBTProjectService projectService)
    {
        _logger = logger;
    ...
    public async Task<IActionResult> Dashboard()
    {
        ...
        model.Projects = (await _companyInfoService.GetAllProjectsAsync(companyId)).Where(p => p.Archived == false)
            .ToList();
    ...
    public async Task<JsonResult> GglProjectTickets()
    {
        ...
        foreach (var prj in projects) chartData.Add(new object[] {prj.Name, prj.Tickets.Count()});
    ...
    public async Task<JsonResult> GglProjectPriority()
    {
        ...
        foreach (var priority in Enum.GetNames(typeof(BTProjectPriority)))
        {
